...
//    m_endpoint.set_error_channels(websocketpp::log::elevel::all);
  ...
  void
  on_socket_init(websocketpp::connection_hdl)
  {
  ...
  void
  on_fail(websocketpp::connection_hdl hdl)
  {
  ...
  void
  on_close_handshake_timeout(websocketpp::connection_hdl hdl)
  {
  }

  void
  on_open(websocketpp::connection_hdl hdl)
  {
    m_hdl = hdl;
    m_manual_close = false;
    if (callbak_open != 0)
  ...
  void
  on_message(websocketpp::connection_hdl hdl, message_ptr msg)
  {
  ...
  void
  on_close(websocketpp::connection_hdl hdl)
  {
  ...
  void
  emit(std::string channel, string &parameter)
  {
    string cmd = "{'event':'addChannel','channel':'";
    cmd += channel;
    cmd += "','parameters':{";
